...
SUGAR_LEVEL_IDX = 0                    # Current sugar level
SUGAR_CAPACITY_IDX = 1                  # Sugar capacity of the cell
PRESENT_AGENT_IDX = 2                   # Agent that is currently on the cell
